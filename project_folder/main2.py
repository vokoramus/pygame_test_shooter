...
#         self.image.fill(GREEN)
        ...
        self.image.set_colorkey(BLACK)  # назначить прозрачный цвет
        self.rect = self.image.get_rect()
# Объект rect в Pygame представлен в формате [x, y, width, height],
# где x и y представляют собой верхний левый угол прямоугольника
        
        self.radius = 20  # для collide_circle()
...
#         self.image.fill(RED)
        ...
        self.rect = self.image.get_rect()
        self.radius = int(self.rect.width * 0.85 / 2)  # для collide_circle()
#         pygame.draw.circle(self.image, RED, self.rect.center, self.radius)
...
#         self.image = pygame.transform.rotate(self.image, self.rot_speed) # ТАК НЕЛЬЗЯ - изображения смазываютя при вращении!!!
